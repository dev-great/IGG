...
class MyQuizListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "name", "description", "image", "slug",
                  "questions_count", "completed", "score", "progress", "timestamp"]
    ...
    def get_progress(self, obj):
        try:
            ...
            if quiztaker.completed == False:
                questions_answered = UsersAnswer.objects.filter(
                    quiz_taker=quiztaker, answer__isnull=False).count()
